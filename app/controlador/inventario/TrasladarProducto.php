...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $actualizar = new ProductosInventario();
    $realizado = $actualizar->actualizarExistenciaInv($codigo_sucursal,$codigoProducto,$cantidadAumentar);
...
<div class="container mt-5">
        <div class="card">
            <div class="card-body">
                ...
                <?php endif; ?>
                <a href="../../vista/inventario/vistaInventario.php" class="btn btn-primary">Salir</a>
            </div>
        </div>
    </div>
